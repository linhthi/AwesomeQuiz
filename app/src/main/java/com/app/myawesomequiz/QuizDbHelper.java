...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionTable() {
        ...
        addQuestion(q3);
        Question q4 = new Question("Hard: A is correct again", "A", "B", "C", 1, Question.DIFFICULTY_HARD);
        addQuestion(q4);
        Question q5 = new Question("Hard: B is correct", "A", "B", "C", 2, Question.DIFFICULTY_HARD);
        addQuestion(q5);
        Question q6 = new Question("Hard: B is correct again", "A", "B", "C", 2, Question.DIFFICULTY_HARD);
        addQuestion(q6);
    }
